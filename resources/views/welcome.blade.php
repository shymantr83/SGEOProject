                ...
                <div class="col-lg-8 d-none d-lg-block">
                    <nav class="mainmenu__nav">
                        <ul class="meninmenu d-flex justify-content-end">
                            <li class="drop with--one--item"><a href="#">{{__("words.Home")}}</a></li>
                            <li class="drop with--one--item "><a href="#">{{__("words.About")}}</a></li>

                            <li class="drop active">{{__("words.specialisation")}}
                                <div class="megamenu_dropdown">
                                    <ul class="item item01">
                                        @foreach ($specializations as $specialisation)

                                        <li><a href="#">{{$specialisation->name}}</a></li>
                                        @endforeach

                                    </ul>
                                </div>
                            </li>
                            <li class="drop with--one--item"><a href="#">{{__("words.Contact")}}</a></li>
                            ...
                            <li class="drop with--one--item"><a href="#">{{__("words.Profile")}}</a></li>
                ...
                <ul>
                    ...
                    <div class="links">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('dialogPage_login') }}">{{ __("words.login") }}</a>
                            </li>
                            @endif

                            @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('dialogPage_register') }}">{{ __("words.register") }}</a>
                            </li>
                            @endif
                            @else
...
{{--    Styles--}}
    ...
    <div class="pppp">
        ...
        <section class="projects">
            <div class="row">
                <div class="project-card col-lg-4 col-md-4 col-xs-4 thumb">
                    <div class="project-img">
                        <a href="#" class="thumbnail"><img src='{{asset("company_image/".$company->logo)}}' alt="img"></a>
                    </div>
